...
@Getter
@ApiModel
public class EmailManagementUpdateRequestDto {
	...
	public boolean isContentsInlineImageEmpty() {
		return this.contentsInlineImage == null || this.contentsInlineImage.isEmpty();
	}
}
