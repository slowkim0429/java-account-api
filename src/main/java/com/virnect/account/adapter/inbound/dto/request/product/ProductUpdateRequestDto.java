...
public class ProductUpdateRequestDto {
	...
	@ApiModelProperty(value = "Product Type", example = "SQUARS", position = 1, required = true)
	@NotNull(message = "Product Type는 반드시 입력되어야 합니다.")
	private ProductType productType;

	@ApiModelProperty(value = "Product 명", example = "리모트", position = 2, required = true)
