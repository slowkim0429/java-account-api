...
public class CouponCreateRequestDto {
	...
	@ApiModelProperty(value = "쿠폰과 매칭되어야 하는 라이센스 등급", example = "UPGRADE_LICENSE_ATTRIBUTE", required = true)
	...
	@ApiModelProperty(value = "쿠폰과 매칭되어야 하는 구독 주기", example = "MONTH", required = true)
	...
	public static CouponCreateRequestDto of(
		String name, String code, Long maxCount, String couponType, ZonedDateTime expiredDate, String description,
		String benefitOption, Long benefitValue,
		String couponLicenseGradeMatchingType,
		String couponRecurringIntervalMatchingType
