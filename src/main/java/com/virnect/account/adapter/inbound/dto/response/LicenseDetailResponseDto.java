...
public class LicenseDetailResponseDto {
	...
	@QueryProjection
	public LicenseDetailResponseDto(
		Long id, Long productId, Long licenseGradeId, String licenseGradeName, LicenseGradeType licenseGradeType,
		String name, String description, ApprovalStatus status, UseStatus useStatus, Long createdBy,
